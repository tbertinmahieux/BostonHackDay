...
\begin{minipage}[c][9cm][c]{0.78\textwidth}
  \begin{center}
    {\sc \Huge A Ground-breaking Work of Epic Proportions}\\[10mm]
    {\Large Phil D. Student and Daniel P. W. Ellis\\[3.5mm]
     \large LabROSA, Dept. of Electrical Engineering, Columbia University \\
    \tt{\{phds,dpwe\}@ee.columbia.edu}}
  \end{center}
\end{minipage}
%%% GK-Logo
\begin{minipage}[c][9cm][c]{0.1\textwidth}
