...
In this section we apply the result of our method to two tasks
unrelated to clustering. We try to demonstrate that the codewords
...
that avoid comparing every code to every sample. Third, the learning
algorithm must not converge too fast. We could add a filter that selects
increasingly hard example to encode, our merge many codebooks in a similar
