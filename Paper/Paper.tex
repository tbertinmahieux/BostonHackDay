...
we take the longest sequence of bars of $4$ beats in the test set.  As
we mentioned before, $4$ beats is the most common bar size using the
Echo Nest segmentation. We then encode this sequence using an offset
of $0$, $1$, $2$ or $3$ beats. The best offset in terms of distortion
should correspond to the bar alignment relative to the original
feature matrix.
...
%The good answer is an offset of $0$.
