...
To illustrate this, imagine a binary array of size $1$. We need two
codes to encode perfectly: $(0)$ and $(1)$. If the binary is now of
size $2$, we need four codes: $(0,0)$, $(0,1)$, $(1,1)$ and $(1,0)$.
