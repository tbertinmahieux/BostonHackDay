...
Figure \ref{fig:lle} visualizes the codebook using locally linear
embedding \cite{Roweis2000} to group near neighbors on a 2 dimensional
plane\footnote{We used the implementation from:
