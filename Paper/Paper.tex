...
selected randomly from the codewords used in the test set. Percentage of
use display in parentheses.
Most patterns are sustained notes, but code 0 shows a repeating two chord
pattern.
}}
