...
\subsection{Codebook}
Visualizing codewords in a meaningful way is always a challenge, even
if we have only a one or two hundreds of them.  We present $3$ figures
in this section that should help the reader foster his
intuition.
...
The 25 most frequently used codewords in the testing set are shown in
...
codewords correspond to transitions from one chord to another, \eg a
transition from one major triad to another (\ie Cmaj to Fmaj assuming
that chroma 0 is C) in code 8.  Does this transition have a better
name like ``relative x''?
...
to visualize the clusters, \ie the pattersn from actual song that
...
<<<<<<< HEAD:Paper/Paper.tex

=======
>>>>>>> 3ca0ce8a9a8930d1801a45c9d081081a2cb5f638:Paper/Paper.tex
