...
\begin{figure}[htb]
\begin{center}
\includegraphics[width=.9\columnwidth]{close_patterns_diff}
\end{center}
\caption{\small{Cluster around the pattern and the difference of both.}}
...
\begin{figure}[htb]
  \centering
  \subfloat[][\small{Metallica}]{\label{fig:metallica2}\includegraphics[width=0.4\columnwidth]{metallica_pattern}}                
  \subfloat[][\small{Tori Amos / Suzanne Vega}]{\label{fig:amosvega2}\includegraphics[width=0.4\columnwidth]{toriamos_suzannevega_pattern}}
